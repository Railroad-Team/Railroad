package dev.railroadide.core.ui.behavior;
...
public class RRToggleButtonBehavior<C extends RRToggleButton> extends ButtonBehavior<C> {
    
    public RRToggleButtonBehavior(C button) {
        super(button);
    ...
    private void traverse(KeyEvent e, String name) {
        RRToggleButton toggleButton = getNode();
