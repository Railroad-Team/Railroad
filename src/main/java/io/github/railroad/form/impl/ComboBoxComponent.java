 ...
 * Can be constructed using {@link FormComponent#comboBox(String, String, Class)} or {@link ComboBoxComponent.Builder}.
 *
 * @see FormComponent
 * @see FormComponent#comboBox(String, String, Class)
 * @see ComboBoxComponent.Builder
 */
