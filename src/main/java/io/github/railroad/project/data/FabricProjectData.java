...
public record FabricProjectData(String projectName, Path projectPath, boolean createGit, License license, String licenseCustom,
                                MinecraftVersion minecraftVersion, FabricLoaderVersion fabricLoaderVersion, Optional<FabricAPIVersion> fapiVersion,
                                String modId, String modName, String mainClass, boolean useAccessWidener, boolean splitSources,
