...
/**
 * A labeled {@link io.github.railroad.core.ui.RRHBox} that can have information labels attached to it.
 *
 * @param <T> The type of the primary component of the labeled {@link io.github.railroad.core.ui.RRHBox}.
 */
@Getter
