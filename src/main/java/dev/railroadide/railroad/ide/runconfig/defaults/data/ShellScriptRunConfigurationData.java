...
public class ShellScriptRunConfigurationData extends RunConfigurationData {
    ...
    public Form createConfigurationForm(Project project, RunConfiguration<?> configuration) {
        var executeModeComponent = FormComponent
            .radioButtonGroup("executeMode", "railroad.runconfig.shell_script.configuration.executeMode.label",
                ExecuteMode.class)
            .required()
        ...
        var environmentValues = this.environmentVariables == null
        ...
        return createBaseFormBuilder(project, configuration)
            .appendSection(FormSection.create("railroad.runconfig.shell_script.configuration.section.title")
                ...
                .appendComponent(FormComponent
                    ...
                    .build())
                .appendComponent(FormComponent
                    .textArea("scriptText", "railroad.runconfig.shell_script.configuration.scriptText.label")
                    .required()
                    ...
                    .build())
                .appendComponent(FormComponent
                    .textField("scriptArgs", "railroad.runconfig.shell_script.configuration.scriptArgs.label")
                ...
                .appendComponent(FormComponent
                    .directoryChooser("workingDirectory",
                        "railroad.runconfig.shell_script.configuration.workingDirectory.label")
                    .required()
                ...
                .appendComponent(FormComponent
                    .textField("environmentVariables",
                        "railroad.runconfig.shell_script.configuration.envVariables.label")
                    ...
                    .build())
                .appendComponent(FormComponent
                    .fileChooser("interpreterPath",
                        "railroad.runconfig.shell_script.configuration.interpreterPath.label")
                    .required()
                    .defaultPath(this.interpreterPath)
                    .validator(field -> ProjectValidators.validateFilePath(field, null))
                    .build())
                .appendComponent(FormComponent
                    .textField("interpreterArgs", "railroad.runconfig.shell_script.configuration.interpreterArgs.label")
                    ...
                    .build())
                .appendComponent(FormComponent
                    .checkBox("executeInTerminal",
                        "railroad.runconfig.shell_script.configuration.executeInTerminal.label")
