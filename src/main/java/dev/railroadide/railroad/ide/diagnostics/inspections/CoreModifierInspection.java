...
public final class CoreModifierInspection implements JavaInspectionRuleProvider {
        ...
        context.traverse(node -> {
            switch (node.kind().id()) {
                ...
                case JAVA_LOCAL_VARIABLE_DECLARATION_STATEMENT ->
                    reportLocalVariableDeclaration(context, reporter, node);
    ...
    private static void reportTypeDeclaration(JavaRuleContext context, JavaInspectionRuleReporter reporter,
        ...
        if (context.enclosingTypeSymbol(node).isEmpty()) {
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PRIVATE_KEYWORD,
                "'private' is not allowed on top-level type declarations");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PROTECTED_KEYWORD,
                "'protected' is not allowed on top-level type declarations");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.STATIC_KEYWORD,
                "'static' is not allowed on top-level type declarations");
        }
        ...
        if (JAVA_INTERFACE_DECLARATION.equals(ownerKindId) || JAVA_ANNOTATION_TYPE_DECLARATION.equals(ownerKindId)) {
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PRIVATE_KEYWORD,
                "'private' is not allowed on interface member types");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PROTECTED_KEYWORD,
                "'protected' is not allowed on interface member types");
        }

        reportIfPresent(reporter, node, modifiers, JavaTokenType.DEFAULT_KEYWORD,
            "'default' is not allowed on type declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.NATIVE_KEYWORD,
            "'native' is not allowed on type declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.SYNCHRONIZED_KEYWORD,
            "'synchronized' is not allowed on type declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.TRANSIENT_KEYWORD,
            "'transient' is not allowed on type declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.VOLATILE_KEYWORD,
            "'volatile' is not allowed on type declarations");
        ...
        if (JAVA_INTERFACE_DECLARATION.equals(kindId)) {
            reportIfPresent(reporter, node, modifiers, JavaTokenType.FINAL_KEYWORD,
                "'final' is not allowed on interface declarations");
        } else if (JAVA_ANNOTATION_TYPE_DECLARATION.equals(kindId)) {
            reportIfPresent(reporter, node, modifiers, JavaTokenType.FINAL_KEYWORD,
                "'final' is not allowed on annotation type declarations");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.SEALED_KEYWORD,
                "'sealed' is not allowed on annotation type declarations");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.NON_SEALED_KEYWORD,
                "'non-sealed' is not allowed on annotation type declarations");
        } else if (JAVA_ENUM_DECLARATION.equals(kindId) || JAVA_RECORD_DECLARATION.equals(kindId)) {
            reportIfPresent(reporter, node, modifiers, JavaTokenType.ABSTRACT_KEYWORD,
                "'abstract' is not allowed on %s declarations".formatted(typeKindDisplayName(kindId)));
            reportIfPresent(reporter, node, modifiers, JavaTokenType.FINAL_KEYWORD,
                "'final' is not allowed on %s declarations".formatted(typeKindDisplayName(kindId)));
            reportIfPresent(reporter, node, modifiers, JavaTokenType.SEALED_KEYWORD,
                "'sealed' is not allowed on %s declarations".formatted(typeKindDisplayName(kindId)));
            reportIfPresent(reporter, node, modifiers, JavaTokenType.NON_SEALED_KEYWORD,
                "'non-sealed' is not allowed on %s declarations".formatted(typeKindDisplayName(kindId)));
        }
    }
    ...
    private static void reportFieldDeclaration(JavaRuleContext context, JavaInspectionRuleReporter reporter,
        ...
        reportConflictingAccessModifiers(reporter, node, modifiers);
        reportIfPresent(reporter, node, modifiers, JavaTokenType.ABSTRACT_KEYWORD,
            "'abstract' is not allowed on field declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.DEFAULT_KEYWORD,
            "'default' is not allowed on field declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.NATIVE_KEYWORD,
            "'native' is not allowed on field declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.SYNCHRONIZED_KEYWORD,
            "'synchronized' is not allowed on field declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.STRICTFP_KEYWORD,
            "'strictfp' is not allowed on field declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.SEALED_KEYWORD,
            "'sealed' is not allowed on field declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.NON_SEALED_KEYWORD,
            "'non-sealed' is not allowed on field declarations");
        ...
        if (JAVA_INTERFACE_DECLARATION.equals(ownerKindId) || JAVA_ANNOTATION_TYPE_DECLARATION.equals(ownerKindId)) {
            ...
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PROTECTED_KEYWORD,
                "'protected' is not allowed on interface fields");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.TRANSIENT_KEYWORD,
                "'transient' is not allowed on interface fields");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.VOLATILE_KEYWORD,
                "'volatile' is not allowed on interface fields");
        }
    ...
    private static void reportMethodDeclaration(JavaRuleContext context, JavaInspectionRuleReporter reporter,
        ...
        reportConflictingAccessModifiers(reporter, node, modifiers);
        reportIfPresent(reporter, node, modifiers, JavaTokenType.TRANSIENT_KEYWORD,
            "'transient' is not allowed on method declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.VOLATILE_KEYWORD,
            "'volatile' is not allowed on method declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.SEALED_KEYWORD,
            "'sealed' is not allowed on method declarations");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.NON_SEALED_KEYWORD,
            "'non-sealed' is not allowed on method declarations");
        ...
        if (modifiers.contains(JavaTokenType.ABSTRACT_KEYWORD)) {
            ...
            reportIfPresent(reporter, node, modifiers, JavaTokenType.NATIVE_KEYWORD,
                "'abstract' cannot be combined with 'native'");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.SYNCHRONIZED_KEYWORD,
                "'abstract' cannot be combined with 'synchronized'");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.STRICTFP_KEYWORD,
                "'abstract' cannot be combined with 'strictfp'");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.DEFAULT_KEYWORD,
                "'abstract' cannot be combined with 'default'");
            if (hasBody) {
                reporter.report(node, "'abstract' methods cannot have a body");
            }
            String ownerQualifiedName = context.enclosingTypeSymbol(node).flatMap(symbol -> symbol.qualifiedName())
                .orElse(null);
            ...
            if (JAVA_ENUM_DECLARATION.equals(ownerKindId) || JAVA_RECORD_DECLARATION.equals(ownerKindId)) {
                reporter.report(node,
                    "'abstract' methods are not allowed in %s types".formatted(typeKindDisplayName(ownerKindId)));
            }
        }
        ...
        if (implicitAbstractLike) {
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PROTECTED_KEYWORD,
                "'protected' is not allowed on abstract interface methods");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.FINAL_KEYWORD,
                "'final' is not allowed on abstract interface methods");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.NATIVE_KEYWORD,
                "'native' is not allowed on abstract interface methods");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.SYNCHRONIZED_KEYWORD,
                "'synchronized' is not allowed on abstract interface methods");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.STRICTFP_KEYWORD,
                "'strictfp' is not allowed on abstract interface methods");
        }

        if (JAVA_INTERFACE_DECLARATION.equals(ownerKindId)) {
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PROTECTED_KEYWORD,
                "'protected' is not allowed on interface methods");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.FINAL_KEYWORD,
                "'final' is not allowed on interface methods");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.NATIVE_KEYWORD,
                "'native' is not allowed on interface methods");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.SYNCHRONIZED_KEYWORD,
                "'synchronized' is not allowed on interface methods");
        ...
        if (JAVA_ANNOTATION_TYPE_DECLARATION.equals(ownerKindId)) {
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PRIVATE_KEYWORD,
                "'private' is not allowed on annotation type elements");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PROTECTED_KEYWORD,
                "'protected' is not allowed on annotation type elements");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.STATIC_KEYWORD,
                "'static' is not allowed on annotation type elements");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.FINAL_KEYWORD,
                "'final' is not allowed on annotation type elements");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.NATIVE_KEYWORD,
                "'native' is not allowed on annotation type elements");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.SYNCHRONIZED_KEYWORD,
                "'synchronized' is not allowed on annotation type elements");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.STRICTFP_KEYWORD,
                "'strictfp' is not allowed on annotation type elements");
            if (hasBody) {
        ...
        if (modifiers.contains(JavaTokenType.DEFAULT_KEYWORD)) {
            ...
            reportIfPresent(reporter, node, modifiers, JavaTokenType.STATIC_KEYWORD,
                "'default' cannot be combined with 'static'");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PRIVATE_KEYWORD,
                "'default' cannot be combined with 'private'");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.FINAL_KEYWORD,
                "'default' cannot be combined with 'final'");
            if (!hasBody) {
    ...
    private static void reportConstructorDeclaration(JavaRuleContext context, JavaInspectionRuleReporter reporter,
        ...
        reportConflictingAccessModifiers(reporter, node, modifiers);
        reportIfPresent(reporter, node, modifiers, JavaTokenType.ABSTRACT_KEYWORD,
            "'abstract' is not allowed on constructors");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.STATIC_KEYWORD,
            "'static' is not allowed on constructors");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.FINAL_KEYWORD,
            "'final' is not allowed on constructors");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.DEFAULT_KEYWORD,
            "'default' is not allowed on constructors");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.NATIVE_KEYWORD,
            "'native' is not allowed on constructors");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.SYNCHRONIZED_KEYWORD,
            "'synchronized' is not allowed on constructors");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.TRANSIENT_KEYWORD,
            "'transient' is not allowed on constructors");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.VOLATILE_KEYWORD,
            "'volatile' is not allowed on constructors");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.SEALED_KEYWORD,
            "'sealed' is not allowed on constructors");
        reportIfPresent(reporter, node, modifiers, JavaTokenType.NON_SEALED_KEYWORD,
            "'non-sealed' is not allowed on constructors");
        ...
        if (JAVA_ENUM_DECLARATION.equals(ownerKindId)) {
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PUBLIC_KEYWORD,
                "'public' is not allowed on enum constructors");
            reportIfPresent(reporter, node, modifiers, JavaTokenType.PROTECTED_KEYWORD,
                "'protected' is not allowed on enum constructors");
        }
    }
