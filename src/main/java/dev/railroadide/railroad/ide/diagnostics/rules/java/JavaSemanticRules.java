...
public final class JavaSemanticRules {
    /**
     * Diagnostic rule with message template: {@code Duplicate declaration for '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Cannot resolve name '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Cannot resolve import '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Duplicate import '%s'}.
     */
    public static final JavaSemanticRule DUPLICATE_IMPORT = new JavaSemanticRule(
        ...
        "Duplicate import '%s'");
    /**
     * Diagnostic rule with message template: {@code Ambiguous import for '%s' between '%s' and '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Ambiguous name '%s' resolved to multiple candidates}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Cannot resolve type '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Cannot resolve member '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Cannot resolve call '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Type '%s' is not accessible from here}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Member '%s' is not accessible from here}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Call '%s' is not accessible from here}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Invalid inheritance: %s}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Type is missing implementation for '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Invalid override for '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Illegal modifier usage: %s}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Invalid control flow: %s}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Missing return: %s}.
     */
    public static final JavaSemanticRule MISSING_RETURN = new JavaSemanticRule(
        ...
        "Missing return: %s");
    /**
     * Diagnostic rule with message template: {@code Cannot assign '%s' to '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Unhandled checked exception '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Unreachable catch for '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Invalid exception type '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Variable '%s' might not have been initialized}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Final variable '%s' cannot be assigned here}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Final field '%s' might not be initialized}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Avoid wildcard import '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Empty 'catch' block}.
     */
    public static final JavaSemanticRule EMPTY_CATCH = new JavaSemanticRule(
        ...
        "Empty 'catch' block");
    /**
     * Diagnostic rule with message template: {@code Public class '%s' must be declared in a file named '%s.java'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Class '%s' should be named in PascalCase}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Method is named 'TODO', consider giving it a meaningful name}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Method is named '_', which is not allowed}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Empty 'synchronized' block}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Empty 'switch' statement}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code 'switch' statement has only a 'default' case, making it redundant}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Field '%s' has a single-letter name, consider giving it a more descriptive name}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Field '%s' has the same name as its containing class '%s', which can be confusing}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Parameter is named '_', which is not allowed}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Unreachable statement}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Interface method '%s' clashes with method in 'java.lang.Object'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Cast to '%s' is stronger than necessary; '%s' is sufficient}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Public method '%s' is not exposed through any implemented interface}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Cast to '%s' conflicts with previous 'instanceof' check for '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Assertion can be replaced with an 'if' statement for better error handling}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Feature envy: '%s' mostly manipulates '%s' instead of its own data. Consider moving the work into '%s'.}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Feature envy: '%s' is tightly coupled to '%s's data; delegate the logic to '%s' or a DTO.}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Constructor calls overridable method '%s'.}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Constructor calls overridden method '%s'.}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Assertion contains side effects, which may not be executed if assertions are disabled}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Method '%s' declares disallowed exception '%s' in its signature}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Constructor leaks 'this' reference via '%s' before the object is fully constructed}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Negative hexadecimal integer literal '%s' in long context may be misinterpreted as a negative integer literal}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Field '%s' can be converted to a local variable}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Interface '%s' may be annotated as '@FunctionalInterface'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code '%s' condition is always '%s' due to hardcoded literal}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code '%s' condition is always '%s' due to compile-time constant evaluation}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code '%s' is known to be '%s' due to data flow analysis, making the condition always '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Call to 'Optional.get()' without preceding 'isPresent()' check may throw 'NoSuchElementException'}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Method '%s' is recursively called without a base case, leading to infinite recursion}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code '%s' implements 'AutoCloseable' but is not used in a try-with-resources statement}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Case '%s' in 'switch' statement falls through to the next case without a break or return statement}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Integer division in floating-point context may lead to loss of precision}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Double negation can be simplified}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Conditional expression '%s' with identical branches}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code 'BigDecimal.equals()' is scale-sensitive; consider 'compareTo() == 0' if numeric equality is intended}.
     */
    ...
    /**
     * Diagnostic rule with message template:
     * {@code Serializable type '%s' cannot be deserialized because non-serializable ancestor '%s' has no accessible no-arg constructor}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Type '%s' declares redundant interface '%s'}.
     */
    ...
    /**
     * Diagnostic rule with message template: {@code Implicit numeric conversion '%s' from '%s' to '%s'}.
     */
