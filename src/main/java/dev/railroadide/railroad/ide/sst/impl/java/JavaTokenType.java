...
public enum JavaTokenType {
    // Trivia tokens
    WHITESPACE, LINE_TERMINATOR, LINE_COMMENT, BLOCK_COMMENT, JAVADOC_COMMENT,

    // Strict Keywords
    ABSTRACT_KEYWORD, ASSERT_KEYWORD, BOOLEAN_KEYWORD, BREAK_KEYWORD, BYTE_KEYWORD, CASE_KEYWORD, CATCH_KEYWORD, CHAR_KEYWORD, CLASS_KEYWORD, CONST_KEYWORD, CONTINUE_KEYWORD, DEFAULT_KEYWORD, DO_KEYWORD, DOUBLE_KEYWORD, ELSE_KEYWORD, ENUM_KEYWORD, EXTENDS_KEYWORD, FINAL_KEYWORD, FINALLY_KEYWORD, FLOAT_KEYWORD, FOR_KEYWORD, GOTO_KEYWORD, IF_KEYWORD, IMPLEMENTS_KEYWORD, IMPORT_KEYWORD, INSTANCEOF_KEYWORD, INT_KEYWORD, INTERFACE_KEYWORD, AT_INTERFACE_KEYWORD, LONG_KEYWORD, NATIVE_KEYWORD, NEW_KEYWORD, PACKAGE_KEYWORD, PRIVATE_KEYWORD, PROTECTED_KEYWORD, PUBLIC_KEYWORD, RETURN_KEYWORD, SHORT_KEYWORD, STATIC_KEYWORD, STRICTFP_KEYWORD, SUPER_KEYWORD, SWITCH_KEYWORD, SYNCHRONIZED_KEYWORD, THIS_KEYWORD, THROW_KEYWORD, THROWS_KEYWORD, TRANSIENT_KEYWORD, TRY_KEYWORD, VOID_KEYWORD, VOLATILE_KEYWORD, WHILE_KEYWORD,

    // Contextual Keywords
    UNDERSCORE_KEYWORD, EXPORTS_KEYWORD, MODULE_KEYWORD, NON_SEALED_KEYWORD, OPEN_KEYWORD, OPENS_KEYWORD, PERMITS_KEYWORD, PROVIDES_KEYWORD, RECORD_KEYWORD, REQUIRES_KEYWORD, SEALED_KEYWORD, TO_KEYWORD, TRANSITIVE_KEYWORD, USES_KEYWORD, VAR_KEYWORD, WITH_KEYWORD, YIELD_KEYWORD, WHEN_KEYWORD,

    // Literal tokens
    NULL_LITERAL, BOOLEAN_LITERAL, NUMBER_INT_LITERAL, NUMBER_HEXADECIMAL_LITERAL, NUMBER_BINARY_LITERAL, NUMBER_OCTAL_LITERAL, NUMBER_FLOATING_POINT_LITERAL, CHARACTER_LITERAL, STRING_LITERAL, TEXT_BLOCK_LITERAL,

    IDENTIFIER,

    // Punctuation tokens
    OPEN_PAREN, CLOSE_PAREN, OPEN_BRACE, CLOSE_BRACE, OPEN_BRACKET, CLOSE_BRACKET, SEMICOLON, COMMA, DOT, ELLIPSIS,
