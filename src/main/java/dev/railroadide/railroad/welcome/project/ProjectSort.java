...
public enum ProjectSort {
    NAME("railroad.home.welcome.sort.name", Comparator.comparing(Project::getAlias)), DATE(
        "railroad.home.welcome.sort.date", Comparator.comparing(Project::getLastOpened).reversed()), NONE(
