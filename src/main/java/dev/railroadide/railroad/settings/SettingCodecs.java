...
public class SettingCodecs {
    public static final SettingCodec<Language, ComboBox<Language>> LANGUAGE = SettingCodec
        ...
        .valueToNode((lang, comboBox) -> comboBox.setValue(lang == null ? Languages.EN_US : lang))
        .jsonDecoder(json -> Language.fromCode(json.getAsString()).orElse(Languages.EN_US))
        .jsonEncoder(lang -> new JsonPrimitive((lang == null ? Languages.EN_US : lang).getFullCode()))
        .createNode(lang -> {
            ...
            comboBox.setConverter(new ComboBoxConverter<>(Language::name, name -> Language.REGISTRY.values().stream()
    ...
    public static final SettingCodec<JavaInspectionRuleSettingsState, JavaInspectionRuleSettingsPane> JAVA_INSPECTION_RULE_SETTINGS = SettingCodec
        ...
        .createNode(_ -> new JavaInspectionRuleSettingsPane(JavaInspectionRuleSettingsState.snapshot()))
