...
public class FormTransformer<T extends Node, V, W> {
    ...
    public void transformSync() {
        ...
        future.whenComplete((result, throwable) -> {
            if (throwable != null) {
                Railroad.LOGGER.error("Failed to transform form component value synchronously", throwable);
                return;
            }
    ...
    public void transform() {
        ...
        try {
            ...
            Railroad.LOGGER.error("Failed to read value from form component", exception);
            return;
        }
        ...
        try {
            ...
            Railroad.LOGGER.error("Failed to start asynchronous form transformation", exception);
            return;
        }
        ...
        future.whenComplete((result, throwable) -> {
            if (throwable != null) {
                Railroad.LOGGER.error("Form transformation failed", throwable);
                return;
            }
