...
import dev.railroadide.railroad.form.impl.*;
...
public abstract class FormComponent<T extends Node & HasSetValue, U, V extends Node, W> {
    ...
    protected FormComponent(
        ...
        this.data.addListener((observable, oldValue, newValue) -> component.set(componentFactory.apply(newValue)));
    ...
    protected void runValidation(V node) {
        ...
        if (result.message() != null) {
            ...
            Railroad.LOGGER.warn("Validation error: {}", L18n.localize(message));
        } else {
